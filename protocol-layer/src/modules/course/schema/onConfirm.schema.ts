    ...
    "message": {
      ...
      "properties": {
        "order": {
              ...
              "items": {
                ...
                "properties": {
                  ...
                  "descriptor": {
                    ...
                    "required": ["name", "short_desc", "long_desc", "images", "media"]
                  },
                  "creator": {
                    "type": "object",
                    "properties": {
                ...
                "required": ["id", "quantity", "descriptor", "creator", "price", "category_ids", "rating", "rateable", "add-ons", "tags"]
              }
            },
            "fulfillments": {
              "type": "array",
          ...
          "required": ["id", "provider", "items", "fulfillments", "quote", "billing", "payments"]
        }
      },
      "required": ["order"]
    }
